...
public class IngresarT extends javax.swing.JInternalFrame {
    ...
    public void AgregarTrabajador(Trabajador t) {
        if (cont < tra.length) {
            ...
            JOptionPane.showMessageDialog(null, "Trabajador registrado: " + tra[cont].getNombre());
            cont++;
        } else {
    ...
    public String listarTrabajador() {
        ...
        if (cont == 0) {
            ...
            for (int i = 0; i < cont; i++) {
                info = info + "  " + tra[i].getRut() + "  " + tra[i].getNombre() + "  " + tra[i].getFono() + "  " + tra[i].getPuesto() + "\n";
            }
        }
        return info;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenés/headhunting.png"))); // NOI18N
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        if (n.isEmpty() == true && r.isEmpty() == true && f.isEmpty() == true) {
            ...
            if (validarNombre(n) == true && validarFono(f) == true && validarRut(r) == true) {
                Trabajador t = new Trabajador(nombre, r, p, f);
