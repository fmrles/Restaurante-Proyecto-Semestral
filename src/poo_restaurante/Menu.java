...
public class Menu extends javax.swing.JFrame { //Herencia
    ...
    private void initComponents() {
        ...
        IngresarDelivery = new javax.swing.JMenuItem();
        ListadoDeClientes = new javax.swing.JMenuItem();
        ListadoDeDeli = new javax.swing.JMenuItem();
        ListarDevporClie = new javax.swing.JMenuItem();
        ListadoDenT = new javax.swing.JMenuItem();
        BuscarCliente = new javax.swing.JMenuItem();
        BuscarDelivery = new javax.swing.JMenuItem();
        ...
        IngresarDelivery.setText("Ingresar Delivery");
        IngresarDelivery.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                IngresarDeliveryActionPerformed(evt);
            }
        });
        GestionarCliyDev.add(IngresarDelivery);
        ...
        ListadoDeDeli.setText("Listado de Delivery");
        ListadoDeDeli.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ListadoDeDeliActionPerformed(evt);
            }
        });
        GestionarCliyDev.add(ListadoDeDeli);

        ListarDevporClie.setText("Listar Pedidos por Cliente");
        ListarDevporClie.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ListarDevporClieActionPerformed(evt);
            }
        });
        GestionarCliyDev.add(ListarDevporClie);

        ListadoDenT.setText("Listado de Pedido en Tabla");
        ListadoDenT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ListadoDenTActionPerformed(evt);
            }
        });
        GestionarCliyDev.add(ListadoDenT);
        ...
        BuscarDelivery.setText("Buscar Delivery");
        BuscarDelivery.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BuscarDeliveryActionPerformed(evt);
            }
        });
        GestionarCliyDev.add(BuscarDelivery);
    ...
    private void IngresarDeliveryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IngresarDeliveryActionPerformed
        if (form1.cont > 0) {
            form3 = new IngresarD(form1);
            desktopPane.add(form3);
            form3.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "Ingrese delivery");
        }
    }//GEN-LAST:event_IngresarDeliveryActionPerformed
    ...
    private void ListadoDeDeliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ListadoDeDeliActionPerformed
        // TODO add your handling code here:
        if (form3.cont > 0) {
    ...
    }//GEN-LAST:event_ListadoDeDeliActionPerformed

    private void BuscarDeliveryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarDeliveryActionPerformed
        // TODO add your handling code here:
        if (form3.cont > 0) {
    ...
    }//GEN-LAST:event_BuscarDeliveryActionPerformed

    private void ListadoDenTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ListadoDenTActionPerformed
        // TODO add your handling code here:
        if (form3.cont > 0) {
    ...
    }//GEN-LAST:event_ListadoDenTActionPerformed

    private void ListarDevporClieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ListarDevporClieActionPerformed
        // TODO add your handling code here:
        if (form3.cont > 0) {
    ...
    }//GEN-LAST:event_ListarDevporClieActionPerformed
    ...
    private void ListarTrabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ListarTrabActionPerformed
        // TODO add your handling code here:
        if (form5.cont > 0) {
            IngresarT form = new IngresarT();
            ListarTrabajadores form2 = new ListarTrabajadores(form); // Dependencia
            desktopPane.add(form2);
            form2.setVisible(true);
        } else {
    ...
    public javax.swing.JMenuItem BuscarDelivery;
    ...
    public javax.swing.JMenuItem IngresarDelivery;
    public javax.swing.JMenuItem IngresarTrabajador;
    public javax.swing.JLabel LOGO;
    public javax.swing.JMenuItem ListadoDeClientes;
    public javax.swing.JMenuItem ListadoDeDeli;
    public javax.swing.JMenuItem ListadoDenT;
    public javax.swing.JMenuItem ListarDevporClie;
